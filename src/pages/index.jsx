...
export default () => (
  <main>
    <h1>Twilights, stars, and orbs</h1>
    <ul>
      <li>
    ...
    <p>
      ...
      middle<sub>2</sub> of an immense dark sphere, whose upper half was strewn
      with silver. The efficient office for ligature testing.
    </p>
    <h2>Velocity</h2>
    <p>
